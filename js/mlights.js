...
function BunnyDemo () {
  ...
  this.light2 = MDN.normalize([-0.5, 1.0, 1.0]);  
  this.light3 = MDN.normalize([-0.5, 1.0, 1.0]);
...
BunnyDemo.prototype.createLocations = function() {
  ...
  var locations = {
    ...
    light2             : gl.getUniformLocation(this.webglProgram, "light2"),
    light3             : gl.getUniformLocation(this.webglProgram, "light3"),
...
BunnyDemo.prototype.updateAttributesAndUniforms = function() {
  ...
  gl.uniform3fv(this.locations.light2, this.light2);
  gl.uniform3fv(this.locations.light3, this.light3);
...
BunnyDemo.prototype.addDatGui = function() {
  ...
  var light2 = {
    lightDirectionX2 : this.light2[0],
    lightDirectionY2 : this.light2[1],
    lightDirectionZ2 : this.light2[2]
  };

  var light3 = {
    lightDirectionX3 : this.light3[0],
    lightDirectionY3 : this.light3[1],
    lightDirectionZ3 : this.light3[2]
  };
  ...
  var syncWithUniforms2 = function() {
    
    if( light2.lightDirectionX2=== 0 && light2.lightDirectionY2 === 0 && light2.lightDirectionZ2 === 0 ) {
      light2.lightDirectionY2 = -1;
    }
    this.light2 = MDN.normalize([
      light2.lightDirectionX2,
      light2.lightDirectionY2,
      light2.lightDirectionZ2
    ]);
    light2.lightDirectionX2 = this.light2[0];
    light2.lightDirectionY2 = this.light2[1];
    light2.lightDirectionZ2 = this.light2[2];
    
  }.bind(this);

  var syncWithUniforms3 = function() {
    
    if( light3.lightDirectionX3=== 0 && light3.lightDirectionY3 === 0 && light3.lightDirectionZ3 === 0 ) {
      light3.lightDirectionY3 = -1;
    }
    this.light3 = MDN.normalize([
      light3.lightDirectionX3,
      light3.lightDirectionY3,
      light3.lightDirectionZ3
    ]);
    light3.lightDirectionX3 = this.light3[0];
    light3.lightDirectionY3 = this.light3[1];
    light3.lightDirectionZ3 = this.light3[2];
  ...
  gui.add(light2, "lightDirectionX2").min(-1).max(1).onChange(syncWithUniforms2);
  gui.add(light2, "lightDirectionY2").min(-1).max(1).onChange(syncWithUniforms2);
  gui.add(light2, "lightDirectionZ2").min(-1).max(1).onChange(syncWithUniforms2);

  gui.add(light3, "lightDirectionX3").min(-1).max(1).onChange(syncWithUniforms3);
  gui.add(light3, "lightDirectionY3").min(-1).max(1).onChange(syncWithUniforms3);
  gui.add(light3, "lightDirectionZ3").min(-1).max(1).onChange(syncWithUniforms3);
